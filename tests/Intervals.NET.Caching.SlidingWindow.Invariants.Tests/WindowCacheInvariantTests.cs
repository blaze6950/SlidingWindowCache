...
namespace Intervals.NET.Caching.SlidingWindow.Invariants.Tests;

/// <summary>
/// Comprehensive test suite verifying all 56 system invariants for SlidingWindowCache.
...
public sealed class WindowCacheInvariantTests : IAsyncDisposable
{
    ...
    public async Task Invariant_SWC_A_2a_UserRequestCancelsRebalance(string executionStrategy, int? queueCapacity)
    {
        // ARRANGE
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_A_1_ConcurrentWriteSafety()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_A_3_UserPathAlwaysServesRequests()
    {
        // ARRANGE
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_A_4_UserPathNeverWaitsForRebalance()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_A_10_UserAlwaysReceivesExactRequestedRange()
    {
        // ARRANGE
        var (cache, _) = TrackCache(TestHelpers.CreateCacheWithDefaults(_domain, _cacheDiagnostics));
    ...
    public async Task Invariant_SWC_A_12_UserPathNeverMutatesCache(
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_A_12b_CacheContiguityMaintained()
    {
        // ARRANGE
        var (cache, _) = TrackCache(TestHelpers.CreateCacheWithDefaults(_domain, _cacheDiagnostics));
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_B_1_CacheDataAndRangeAlwaysConsistent()
    {
        // ARRANGE
        var (cache, _) = TrackCache(TestHelpers.CreateCacheWithDefaults(_domain, _cacheDiagnostics));
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_B_5_Enhanced_CancellationDuringIO()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_B_6_OnlyLatestResultsApplied()
    {
    ...
    [Theory]
    [MemberData(nameof(ExecutionStrategyTestData))]
    public async Task Invariant_SWC_C_1_AtMostOneActiveIntent(string executionStrategy, int? queueCapacity)
    {
        // ARRANGE
        var options = TestHelpers.CreateDefaultOptions(
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_C_2_PreviousIntentBecomesObsolete()
    {
        // ARRANGE
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_C_4_DecisionEngineExitsEarlyForObsoleteIntent()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_C_8_IntentDoesNotGuaranteeExecution()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_C_7_SystemStabilizesUnderLoad()
    {
        // ARRANGE
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_D_3_NoRebalanceIfRequestInNoRebalanceRange()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_D_5_Stage2_SkipsWhenWithinPendingNoRebalanceRange()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_D_4_SkipWhenDesiredEqualsCurrentRange()
    {
        // ARRANGE
        var options = TestHelpers.CreateDefaultOptions(
            leftCacheSize: 1.0,
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_E_2_DesiredRangeIndependentOfCacheState()
    {
    ...
    [Theory]
    [MemberData(nameof(ExecutionStrategyTestData))]
    public async Task Invariant_SWC_F_1_G_4_RebalanceCancellationBehavior(string executionStrategy, int? queueCapacity)
    {
    ...
    public async Task Invariant_SWC_F_2a_RebalanceNormalizesCache(string storageName, UserCacheReadMode readMode)
    {
        // ARRANGE
        _ = storageName;
        var options = TestHelpers.CreateDefaultOptions(
    ...
    [Theory]
    [MemberData(nameof(StorageStrategyTestData))]
    public async Task Invariant_SWC_F_6_F_7_F_8_PostExecutionGuarantees(string storageName, UserCacheReadMode readMode)
    {
        // ARRANGE
        _ = storageName;
        var options = TestHelpers.CreateDefaultOptions(
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_F_4_IncrementalFetchOptimization()
    {
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_F_5_DataPreservationDuringExpansion()
    {
        ...
        var initialFetchedRanges = new List<Range<int>>(fetchedRanges);
    ...
    /// </summary>
    [Fact]
    public async Task Invariant_SWC_G_1_G_2_G_3_ExecutionContextSeparation()
    {
        // ARRANGE
        var options = TestHelpers.CreateDefaultOptions(debounceDelay: TimeSpan.FromMilliseconds(100));
        var (cache, _) = TrackCache(TestHelpers.CreateCacheWithDefaults(_domain, _cacheDiagnostics, options));
