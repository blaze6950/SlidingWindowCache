...
/// <summary>
/// Tests that validate Intervals.NET.Caching assumptions about range semantics and behavior.
...
public sealed class RangeSemanticsContractTests : IAsyncDisposable
{
    ...
    public async Task FiniteRange_BoundaryAlignment_ReturnsCorrectValues()
    {
        // ARRANGE
        var cache = CreateCache();
        var range = Factories.Range.Closed<int>(50, 55);
    ...
    public async Task FiniteRange_MultipleRequests_ConsistentLengths()
    {
        ...
        var ranges = new[]
        {
            Factories.Range.Closed<int>(10, 20), // 11 elements
            Factories.Range.Closed<int>(100, 199), // 100 elements
            Factories.Range.Closed<int>(500, 501) // 2 elements
        };
    ...
    public async Task FiniteRange_DataContentMatchesRange_SequentialValues()
    {
        // ARRANGE
        var cache = CreateCache();
        var range = Factories.Range.Closed<int>(1000, 1010);
    ...
    public async Task InfiniteBoundary_LeftInfinite_CacheHandlesGracefully()
    {
        ...
        var range = Factories.Range.Closed<int>(int.MinValue + 1000, int.MinValue + 1100);
    ...
    public async Task InfiniteBoundary_RightInfinite_CacheHandlesGracefully()
    {
        ...
        var range = Factories.Range.Closed<int>(int.MaxValue - 1100, int.MaxValue - 1000);
    ...
    public async Task SpanConsistency_AfterCacheExpansion_LengthStillCorrect()
    {
        ...
        var range1 = Factories.Range.Closed<int>(100, 110);
        ...
        var range2 = Factories.Range.Closed<int>(105, 115);
    ...
    public async Task SpanConsistency_OverlappingRanges_EachReturnsCorrectLength()
    {
        ...
        var ranges = new[]
        {
            Factories.Range.Closed<int>(100, 120),
            Factories.Range.Closed<int>(110, 130),
            Factories.Range.Closed<int>(115, 125)
        };
    ...
    public async Task ExceptionHandling_CacheDoesNotThrow_UnlessDataSourceThrows()
    {
        ...
        var validRanges = new[]
        {
            ...
            Factories.Range.Closed<int>(1000, 2000),
            Factories.Range.Closed<int>(50, 51)
        };
    ...
    public async Task BoundaryEdgeCase_ZeroCrossingRange_HandlesCorrectly()
    {
        // ARRANGE
        var cache = CreateCache();
        var range = Factories.Range.Closed<int>(-10, 10);
    ...
    public async Task BoundaryEdgeCase_NegativeRange_ReturnsCorrectData()
    {
        // ARRANGE
        var cache = CreateCache();
        var range = Factories.Range.Closed<int>(-100, -90);
