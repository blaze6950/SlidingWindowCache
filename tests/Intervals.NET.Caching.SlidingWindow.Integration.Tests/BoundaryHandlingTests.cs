...
public sealed class BoundaryHandlingTests : IAsyncDisposable
{
    ...
    public async Task RebalancePath_PhysicalDataMiss_CacheContainsOnlyAvailableData()
    {
        ...
        var initialRequest = Factories.Range.Closed<int>(1100, 1200);
        ...
        var belowBoundsRequest = Factories.Range.Closed<int>(900, 950);
    ...
    public async Task RebalancePath_PartialMiss_LowerBoundary_CacheExpandsToLimit()
    {
        ...
        var requestNearBoundary = Factories.Range.Closed<int>(1050, 1150);
        ...
        var boundaryRequest = Factories.Range.Closed<int>(1000, 1010);
    ...
    public async Task RebalancePath_PartialMiss_UpperBoundary_CacheExpandsToLimit()
    {
        ...
        var requestNearBoundary = Factories.Range.Closed<int>(9850, 9950);
        ...
        // Verify by requesting data at the boundary
        var boundaryRequest = Factories.Range.Closed<int>(9990, 9999);
        var boundaryResult = await cache.GetDataAsync(boundaryRequest, CancellationToken.None);
    ...
    public async Task RebalancePath_FullHit_WithinBounds_CacheExpandsNormally()
    {
        ...
        var requestInMiddle = Factories.Range.Closed<int>(5000, 5100);
        ...
        var leftExpanded = Factories.Range.Closed<int>(4900, 4950);
        ...
        var rightExpanded = Factories.Range.Closed<int>(5150, 5200);
    ...
    public async Task RebalancePath_CompleteDataMiss_IncrementsDataSegmentUnavailable()
    {
        ...
        var initialRequest = Factories.Range.Closed<int>(1000, 1010);
    ...
    private SlidingWindowCache<int, int, IntegerFixedStepDomain> CreateCacheWithLeftExpansion()
    {
        var options = new SlidingWindowCacheOptions(
    ...
    private SlidingWindowCache<int, int, IntegerFixedStepDomain> CreateCacheWithRightExpansion()
    {
        var options = new SlidingWindowCacheOptions(
            leftCacheSize: 1.0,
