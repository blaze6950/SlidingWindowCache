...
/// <summary>
/// Tests validating the interaction contract between SlidingWindowCache and IDataSource.
...
public sealed class CacheDataSourceInteractionTests : IAsyncDisposable
{
    ...
    public async Task CacheMiss_ColdStart_DataSourceReceivesExactRequestedRange()
    {
        ...
        var requestedRange = Factories.Range.Closed<int>(100, 110);
    ...
    public async Task CacheMiss_NonOverlappingJump_DataSourceReceivesNewRange()
    {
        ...
        var newRange = Factories.Range.Closed<int>(500, 510);
    ...
    public async Task PartialCacheHit_OverlappingRange_FetchesOnlyMissingSegments()
    {
        ...
        var overlappingRange = Factories.Range.Closed<int>(105, 120);
    ...
    public async Task PartialCacheHit_LeftExtension_DataCorrect()
    {
        ...
        var leftExtendRange = Factories.Range.Closed<int>(190, 205);
    ...
    public async Task PartialCacheHit_RightExtension_DataCorrect()
    {
        ...
        var rightExtendRange = Factories.Range.Closed<int>(305, 320);
    ...
    public async Task Rebalance_WithExpansionCoefficients_ExpandsCacheCorrectly()
    {
        ...
        _dataSource.Reset();
        var withinExpanded = Factories.Range.Closed<int>(85, 95);
    ...
    public async Task Rebalance_SequentialRequests_CacheAdaptsToPattern()
    {
        ...
        var ranges = new[]
        {
            ...
            Factories.Range.Closed<int>(120, 130),
            Factories.Range.Closed<int>(140, 150)
        };
    ...
    {
        // ARRANGE
        var cache = CreateCache(new SlidingWindowCacheOptions(1, 1, UserCacheReadMode.Snapshot, 0.4, 0.4));
    ...
    public async Task NoRedundantFetches_SubsetOfCache_NoAdditionalFetch()
    {
        ...
        await cache.GetDataAsync(Factories.Range.Closed<int>(100, 200), CancellationToken.None);
        await cache.WaitForIdleAsync();
        ...
        var subset = Factories.Range.Closed<int>(150, 160);
    ...
    public async Task DataSourceCalls_MultipleCacheMisses_EachTriggersFetch()
    {
        ...
        {
            Factories.Range.Closed<int>(100, 110),
            Factories.Range.Closed<int>(1000, 1010),
            Factories.Range.Closed<int>(10000, 10010)
        };
    ...
    public async Task EdgeCase_VerySmallRange_SingleElement_HandlesCorrectly()
    {
        ...
        // ACT
        var singleElementRange = Factories.Range.Closed<int>(42, 42);
    ...
    public async Task EdgeCase_VeryLargeRange_HandlesWithoutError()
    {
        ...
        var largeRange = Factories.Range.Closed<int>(0, 999);
