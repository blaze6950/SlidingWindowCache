...
public sealed class DataSourceRangePropagationTests : IAsyncDisposable
{
    ...
    public async Task Rebalance_ColdStart_ExpandsSymmetrically()
    {
        ...
        _dataSource.AssertRangeRequested(Intervals.NET.Factories.Range.Closed<int>(100, 110));
    ...
    public async Task Rebalance_RightMovement_ExpandsRightSide()
    {
        ...
        var rightRange = Intervals.NET.Factories.Range.Closed<int>(120, 130);
        ...
        _dataSource.AssertRangeRequested(Intervals.NET.Factories.Range.OpenClosed<int>(130, 141));
    }
    ...
    public async Task Rebalance_LeftMovement_ExpandsLeftSide()
    {
        ...
        var leftRange = Intervals.NET.Factories.Range.Closed<int>(180, 190);
