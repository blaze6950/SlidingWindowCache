...
/// <summary>
/// Unit tests for <see cref="WindowCacheOptionsBuilder"/> that verify fluent API,
/// default values, required-field enforcement, and <see cref="WindowCacheOptions"/> output.
/// </summary>
public class WindowCacheOptionsBuilderTests
{
    ...
    {
        // ARRANGE
        var builder = new WindowCacheOptionsBuilder();
    ...
    {
        // ARRANGE
        var builder = new WindowCacheOptionsBuilder().WithLeftCacheSize(1.0);
    ...
    {
        // ARRANGE
        var builder = new WindowCacheOptionsBuilder().WithRightCacheSize(1.0);
    ...
    {
        // ARRANGE
        var builder = new WindowCacheOptionsBuilder().WithCacheSize(1.5);
    ...
    {
        // ARRANGE
        var builder = new WindowCacheOptionsBuilder().WithCacheSize(1.0, 2.0);
    ...
    public void Build_WithZeroCacheSize_DoesNotThrow()
    {
        ...
        var exception = Record.Exception(() =>
            new WindowCacheOptionsBuilder().WithCacheSize(0.0).Build());
    ...
    {
        // ASSERT
        Assert.True(typeof(WindowCacheOptionsBuilder).IsSealed);
    }
    ...
    public void WindowCacheOptionsBuilder_HasPublicParameterlessConstructor()
    {
        ...
        var ctor = typeof(WindowCacheOptionsBuilder)
