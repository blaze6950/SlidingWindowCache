...
/// <summary>
/// Unit tests for <see cref="RangeCacheDataSourceAdapter{TRange,TData,TDomain}"/>.
...
public sealed class SlidingWindowCacheDataSourceAdapterTests
{
    ...
    private static Mock<IRangeCache<int, int, IntegerFixedStepDomain>> CreateCacheMock() => new(MockBehavior.Strict);

    private static RangeCacheDataSourceAdapter<int, int, IntegerFixedStepDomain> CreateAdapter(
    ...
    public void Constructor_WithNullCache_ThrowsArgumentNullException()
    {
        ...
        var exception = Record.Exception(() =>
            new RangeCacheDataSourceAdapter<int, int, IntegerFixedStepDomain>(null!));
    ...
    public async Task FetchAsync_PassesCorrectRangeToGetDataAsync()
    {
        ...
        mock.Setup(c => c.GetDataAsync(It.IsAny<Range<int>>(), It.IsAny<CancellationToken>()))
            .Returns<Range<int>, CancellationToken>((r, _) =>
            {
                capturedRange = r;
