...
/// by <see cref="IRangeCache{TRange,TData,TDomain}.GetDataAsync"/>. It tells the caller whether the
...
/// <para>
/// The value is the foundation for opt-in hybrid consistency extension methods such as
