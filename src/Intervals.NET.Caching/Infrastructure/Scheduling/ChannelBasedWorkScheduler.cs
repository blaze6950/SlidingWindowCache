...
/// <summary>
/// Channel-based work scheduler that serializes work item execution using a bounded
...
/// </list>
/// <para>See also: <see cref="TaskBasedWorkScheduler{TWorkItem}"/> for the unbounded alternative.</para>
/// </remarks>
internal sealed class ChannelBasedWorkScheduler<TWorkItem> : WorkSchedulerBase<TWorkItem>
    where TWorkItem : class, ISchedulableWorkItem
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ChannelBasedWorkScheduler{TWorkItem}"/>.
    /// </summary>
    /// <param name="executor">
    ...
    /// </para>
    /// </remarks>
    public ChannelBasedWorkScheduler(
    ...
    public override async ValueTask PublishWorkItemAsync(TWorkItem workItem, CancellationToken loopCancellationToken)
    {
        if (IsDisposed)
        {
            throw new ObjectDisposedException(
                nameof(ChannelBasedWorkScheduler<TWorkItem>),
