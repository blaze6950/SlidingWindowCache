namespace Intervals.NET.Caching.Core.State;
...
/// <see cref="Intervals.NET.Caching.Public.Configuration.WindowCacheOptions"/>,
...
/// in <see cref="Intervals.NET.Caching.Public.Configuration.WindowCacheOptions"/>
...
/// <see cref="Intervals.NET.Caching.Public.Configuration.WindowCacheOptions"/> (must be ≥ 0);
