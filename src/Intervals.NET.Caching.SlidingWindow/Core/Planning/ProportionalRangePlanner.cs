...
///   <c>ISlidingWindowCache.UpdateRuntimeOptions</c> without reconstructing the planner. Changes take effect on the
...
/// <list type="bullet">
///   <item><description>SWC.E.1: DesiredCacheRange is computed solely from RequestedRange + config</description></item>
///   <item><description>SWC.E.2: DesiredCacheRange is independent of current cache contents</description></item>
///   <item><description>SWC.E.3: DesiredCacheRange defines canonical state for convergence semantics</description></item>
///   <item><description>SWC.E.4: Sliding window geometry is determined solely by configuration</description></item>
///   <item><description>SWC.D.1, SWC.D.2: Analytical/pure (CPU-only), never mutates cache state</description></item>
/// </list>
    ...
    where TDomain : IRangeDomain<TRange>
{
    ...
    ///     changes published via <c>ISlidingWindowCache.UpdateRuntimeOptions</c> take effect on the next cycle.
    /// </param>
    ...
    /// </para>
    /// <para>
    ///   <b>References:</b> Invariants SWC.E.1-SWC.E.4, SWC.D.1-SWC.D.2 (see <c>docs/invariants.md</c>).
    /// </para>
    /// </remarks>
    ...
    ///     <item><description>Enforces Invariants: SWC.E.1 (function of <c>RequestedRange + config</c>), SWC.E.2 (independent of cache state), SWC.E.3 (defines canonical convergent target), SWC.D.1-SWC.D.2 (analytical/CPU-only)</description></item>
    ///   </list>
    /// </para>
    /// <para>
