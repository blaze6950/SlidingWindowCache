...
/// <para>
/// The concrete implementation is selected by <see cref="SlidingWindowCache{TRange,TData,TDomain}"/>
/// based on <see cref="Public.Configuration.SlidingWindowCacheOptions.RebalanceQueueCapacity"/>:
/// </para>
/// <list type="bullet">
/// <item><description>
