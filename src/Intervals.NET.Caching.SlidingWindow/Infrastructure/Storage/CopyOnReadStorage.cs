    ...
    where TDomain : IRangeDomain<TRange>
{
    ...
    /// <para>
    /// This method implements a dual-buffer pattern to satisfy Invariants SWC.A.12, SWC.B.1-SWC.B.2:
    /// </para>
    /// <list type="number">
    ...
    /// storage remains unchanged during enumeration, satisfying Invariant SWC.A.12b (cache contiguity).
    /// </para>
    /// <para>
